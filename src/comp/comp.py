...
c = [person.name for person in humans if person.name[0] > "B" and person.name[0] < "H"]
print(c)
...
f = [(person.name, person.age) for person in humans if 27 <= person.age and 32 >= person.age]
print(f)
